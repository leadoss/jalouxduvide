...
const diffusers: Product[] = [
  {
    ...
    hoverImage: "/products/diffusers/eden-2.png",
    isBestseller: true,
    isNew: false,
    stock: 1,
  ...
  },
  {
    ...
    hoverImage: "/products/diffusers/focus-2.png",
    isBestseller: false,
    isNew: false,
    collection: "Diffusers",
  },
  {
    ...
    hoverImage: "/products/diffusers/cool-2.png",
    isBestseller: false,
    isNew: true,
    collection: "Diffusers",
  },
  {
    ...
    hoverImage: "/products/diffusers/calm-2.png",
    isBestseller: false,
    isNew: false,
    collection: "Diffusers",
  },
  {
    ...
    hoverImage: "/products/diffusers/warmth-2.png",
    isBestseller: true,
    isNew: false,
    collection: "Diffusers",
  },
  {
    ...
    hoverImage: "/products/diffusers/grounded-2.png",
    isBestseller: false,
    isNew: false,
    collection: "Diffusers",
  },
  {
    ...
    hoverImage: "/products/diffusers/confident.jpg",
    isBestseller: false,
    isNew: true,
    collection: "Diffusers",
  },
...
const concretePotCandles: Product[] = [
  {
    ...
    scentFamily: "Floral",
    scents: ["Lavender", "Vanilla", "Jasmine", "Passion Fruit", "Gardenia"],
    description: "A sculptural sphere covered in a coral-like surface that catches light from every angle. Playful, poetic, and utterly unlike anything else on your shelf.",
    ...
    sizes: [{ label: "Standard", volume: "", price: 10, sku: "CP-COR-200" }],
  ...
  },
  {
    ...
    scentFamily: "Floral",
    scents: ["Lavender", "Vanilla", "Jasmine", "Passion Fruit", "Gardenia"],
    description: "Engraved with carousel horses and baroque flourishes, resting on its own ornate display plate. The crown jewel of the collection.",
    ...
    sizes: [{ label: "Standard", volume: "", price: 13, sku: "CP-MAN-200" }],
  ...
  },
  {
    ...
    scentFamily: "Woody",
    scents: ["Lavender", "Vanilla", "Jasmine", "Passion Fruit", "Gardenia"],
    description: "Carved with deep wood-grain lines that feel like ancient timber. Écorce brings the quiet dignity of the forest indoors.",
    ...
    sizes: [{ label: "Standard", volume: "", price: 10, sku: "CP-ECO-200" }],
  ...
  },
  {
    ...
    scentFamily: "Gourmand",
    scents: ["Lavender", "Vanilla", "Jasmine", "Passion Fruit", "Gardenia"],
    description: "Rimmed with pleated ruffled edges like a classic French tart mould. An effortlessly chic piece that doubles as a decorative dish between burns.",
    story: "Named for the tarte aux fruits mould found in every Parisian pâtisserie. Simple in form, striking in white.",
    sizes: [{ label: "Standard", volume: "", price: 10, sku: "CP-TAR-200" }],
  ...
  },
  {
    ...
    scentFamily: "Woody",
    scents: ["Lavender", "Vanilla", "Jasmine", "Passion Fruit", "Gardenia"],
    description: "A rough-hewn cylinder with a crackling wooden wick and matching lidded top. Honest, architectural, and made to last.",
    story: "Hand-cast in a single pour and left unsmoothed. Every scratch and pit on the white surface is part of the design.",
    sizes: [{ label: "Standard", volume: "", price: 10, sku: "CP-BRU-200" }],
  ...
  },
  {
    ...
    scentFamily: "Floral",
    scents: ["Lavender", "Vanilla", "Jasmine", "Passion Fruit", "Gardenia"],
    description: "A goblet vessel adorned with floral and baroque relief, crowned with a sculptural lid. Feminine, opulent, and completely unforgettable.",
    ...
    sizes: [{ label: "Standard", volume: "", price: 13, sku: "CP-ROS-200" }],
  ...
  },
  {
    ...
    scentFamily: "Fresh",
    scents: ["Lavender", "Vanilla", "Jasmine", "Passion Fruit", "Gardenia"],
    description: "A perfectly smooth egg-shaped vessel resting on a natural wood disc. The quietest object in the room — and somehow the one everyone notices first.",
    story: "Conceived as an object of pure presence. No texture, no ornament — just a clean white form and the light it catches.",
    sizes: [{ label: "Standard", volume: "", price: 10, sku: "CP-DOM-200" }],
  ...
  },
  {
    ...
    scentFamily: "Earthy",
    scents: ["Lavender", "Vanilla", "Jasmine", "Passion Fruit", "Gardenia"],
    description: "A teardrop vessel, slightly tapered at the top and grounded at the base. Simple in silhouette — the piece that anchors the room without demanding attention.",
    ...
    sizes: [{ label: "Standard", volume: "", price: 10, sku: "CP-LAR-200" }],
