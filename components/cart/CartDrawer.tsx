          ...
          >
            ...
            {items.length > 0 && (
              <div className="border-t border-gray-200 bg-white px-5 py-5 space-y-3">
                ...
                <Link
                  href="/checkout"
                  className="block w-full text-center bg-black text-white text-[14px] font-500 tracking-[0.06em] uppercase py-4 hover:bg-gray-900 transition-colors duration-200"
                >
                  Check out
                </Link>
                <button
